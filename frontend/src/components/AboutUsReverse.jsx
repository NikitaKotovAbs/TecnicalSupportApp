...
const AboutUsReverse = ({ text, headline, image, headlineWordsPerLine = 4, textWordsPerLine = 7 }) => {
    ...
    return (
        <div className="flex flex-col md:flex-row items-center p-6">
            <div className="flex justify-center items-center w-full md:w-[55%] h-auto mb-4 md:mb-0">
